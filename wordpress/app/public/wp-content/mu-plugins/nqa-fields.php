<?php
/**
 * Plugin Name: NQA – Entity Field Groups (ACF)
 * Description: Registers per-entity-type ACF field groups (Person / Organization / Event /
 *              Place) in code so the schema is version-controlled and deployable. Provenance
 *              fields (source/citation/link) and the cross-type `relationship` field reuse
 *              their existing names so migrated values carry over. Materials keep the
 *              existing DB "Item Details" group.
 * Version:     1.0.0
 */
...
add_action( 'acf/init', function () {
	...
	$all_types = array( 'post', 'nqa_person', 'nqa_org', 'nqa_event', 'nqa_place' );
	...
	acf_add_local_field_group( array(
		...
		'fields'   => array_merge( array(
			array(
				'key' => 'field_nqa_org_type', 'label' => 'Organization type', 'name' => 'org_type', 'type' => 'select',
				'choices' => array(
					'non-profit' => 'Non-profit', 'business' => 'Business', 'activist' => 'Activist group',
					'healthcare' => 'Healthcare', 'faith' => 'Faith', 'arts' => 'Arts', 'community' => 'Community group',
					'indigenous' => 'Indigenous', 'government' => 'Government', 'other' => 'Other',
				),
				'allow_null' => 1, 'ui' => 1,
			),
			array(
				'key' => 'field_nqa_org_status', 'label' => 'Status', 'name' => 'status', 'type' => 'select',
				'choices' => array( 'active' => 'Active', 'defunct' => 'Defunct', 'hiatus' => 'On hiatus', 'unknown' => 'Unknown' ),
				'default_value' => 'active', 'allow_null' => 1, 'ui' => 1,
			),
	...
	acf_add_local_field_group( array(
		...
		'fields'   => array_merge( array(
			array(
				'key' => 'field_nqa_plc_type', 'label' => 'Place type', 'name' => 'place_type', 'type' => 'select',
				'choices' => array(
					'venue' => 'Venue', 'bar' => 'Bar / club', 'centre' => 'Community centre', 'park' => 'Park',
					'faith' => 'Faith institution', 'business' => 'Business', 'landmark' => 'Landmark', 'other' => 'Other',
				),
				'allow_null' => 1, 'ui' => 1,
			),
